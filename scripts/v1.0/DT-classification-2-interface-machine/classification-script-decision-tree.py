#--------------------------Decision tree approach with complete rules and using 8 features--------------------------------------
'''This scripts  does real-time classification of the flows and prioritization/de-prioritization on 2-interface machine and Airtight AP.
